...
#define STRING_CONFIG_H_AUTHOR "(Guti., HICTOP i3 Mendel v1.1.9)" // Who made the changes.
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 160, 160, 398, 418.5 }
